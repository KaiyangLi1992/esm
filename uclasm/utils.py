...
def load_klepto(filepath, print_msg):
    # path = '/home/kli16/Ori_GLSearch/GLSearch/save/OurModelData/aids700nef_train_test_mcs_bfs_one_hot_local_degree_profile_None.klepto'
    # rtn = klepto.archives.file_archive(path)
    rtn = klepto.archives.file_archive(filepath)
    rtn.load()
    # print(klepto.__version__)
    # print(pat
    # print(len(rtn))
