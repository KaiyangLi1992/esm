...
# def from_local_bounds(tmplt,world,matching,local_costs,global_costs,fixed_costs):
def from_local_bounds(smp):
    ...
    # partial_match_cost = np.sum([smp.local_costs[match]/2  for match in matching])
