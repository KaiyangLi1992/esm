...
with open('/home/kli16/ISM_custom/esm/uclasm/matching/Email_trainset_dens_0.5_n_10.pkl','rb') as f:
    train_dataset = pickle.load(f)
with open('/home/kli16/ISM_custom/esm/uclasm/matching/Email_testset_dens_0.5_n_10.pkl','rb') as f:
    test_dataset = pickle.load(f)
test_dataset.gs[0].nxgraph.init_x = train_dataset.gs[0].nxgraph.init_x

with open('/home/kli16/ISM_custom/esm/uclasm/matching/Email_testset_dens_0.2_n_8_num_50_new.pkl','wb') as f:
